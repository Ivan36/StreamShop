        ...
        <li class="nav-item">
          ...
          <div id="content-wrapper">
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="container">
                  <h2 class="form-signin-heading" style = "color:green;">CURRENT CLIENTS</h2><hr />
                  <button class="btn btn-info" type="button" id="btn-add" onclick="href="addroles.php""><i class="fas fa-fw fa-plus-circle"></i> &nbsp; ADD USERS</button>
                  ...
                  <div class="content-loader">
                    <table cellspacing="0" width="100%" id="employee_data" class="table table-striped table-bordered table-hover table-responsive">
                      ...
                      <tbody>
                        ...
                        $stmt = $DB_con->prepare("SELECT * FROM users WHERE type='client'and Active!='NULL' ORDER BY uID");
                        $stmt->execute();
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <a class="btn btn-info" href="editform.php?edit_id=<?php echo $row['uID']; ?>" title="click for edit" onclick="return confirm('sure to edit = <?php echo $row['uID']; ?> ?')">
                                <i class="fas fa-fw fa-edit"></i>
                              </a>
                            </td>
                            <td align="center">
                              <a class="btn btn-danger" name="inactive" href="update.php?delete_id=<?php echo $row['uID']; ?>" title="click for delete" onclick="return confirm('sure to delete = <?php echo $row['uID']; ?> ?')">
