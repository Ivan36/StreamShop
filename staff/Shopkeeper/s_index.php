                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="list-group">
                            <a href="index.php" class="list-group-item ">Stock</a>
                            <a href="ViewOrders.php" class="list-group-item">Orders</a>
                            <a href="inquiry.php" class="list-group-item">Inquiries</a>
                            <a href="VerifiedOders.php" class="list-group-item">Verified Orders</a>
                            <a href ="s_process.php?action=logout" class="list-group-item" name = "logout">Logout</a>
                        </div>
                    </div>
                    <div class="col-sm-9">
