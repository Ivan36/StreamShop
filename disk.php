...
<?php
include("config.php");
$selected = mysqli_query($conn, "SELECT * FROM products where productType='disk' AND Active!='NULL';");
//$i = 1;
?>
<head>
...
<body>
    ...
    <div class="b-container">
        <div class="row">
           ...
           <h2 class="dischead" style="color:green;text-align: center;">Storage devices</h2>
